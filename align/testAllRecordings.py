...
#                       'Nurten_Demirkol'
     ...
     for recMBID,  recordingDir in zip(recMBIDs,  recordingDirs ):
        ...
        # get sectionLink
        sectionLinkFilename = recMBID + '-scorealign-0.1-sectionlinks-1.json'
...
def downloadSectionLink(recMBID, recordingDir, compositionPath, sectionLinkFilename):
    ...
    sectionLinkKoraURI = '/incoming/Turkey-makam/derived/' + firstTwoDigits + '/' + recMBID + '/scorealign/0.1/' + sectionLinkFilename
