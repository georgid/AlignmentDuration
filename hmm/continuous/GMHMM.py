...
#         self._set_GMMs()
    ...
    def __init__(self,statesNetwork, numMixtures, numDimensions, transMatrices):
        '''
        See base class constructor for more information
        '''
        super(GMHMM,self).__init__(statesNetwork, numMixtures, numDimensions, transMatrices)
        self._set_GMMs()
