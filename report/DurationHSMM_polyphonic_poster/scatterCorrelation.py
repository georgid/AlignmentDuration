...
pyplot.scatter(scoreDev[i], noDurationError[i], marker='D', color='cyan', facecolors='none', s=100, label='HMM polyphonic')
pyplot.scatter(scoreDev[i], durationError[i], marker='D', color='red', s=50, label='DHMM polyphonic')
