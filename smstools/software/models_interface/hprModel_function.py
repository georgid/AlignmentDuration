# function to call the extractHarmSpec analysis/synthesis functions in software/models/hprModel.py
...
def extractHarmSpec(inputFile='../../sounds/sax-phrase-short.wav', window='blackman', M=601, N=1024, t=-100, 
