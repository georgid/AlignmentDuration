...
def divideIntoSentencesFromAnnoWithSil_andCreateLyrics(annotationURI, syllRefDurations):
    '''
    infer section/line timestamps from annotation-textgrid, 
    parse divison into sentences from Tier 'lines' and load the timestamps of each line's syllables 
    '''
